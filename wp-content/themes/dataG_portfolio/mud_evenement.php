...
{tooltip}<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/informations.png" alt="Informations" /> {end-texte|w=350|mood=800|tipd=1000|offsety=50}<h2>Objectif:</h2>
		...
		<div id="bloc_page_site">
			...
			<article class="mud_article">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/concert_scene.jpg" alt="Scene de concert." class="img_article"/>
					<h3 class="mud_h3">FORMULES</h3>
				<p>
				 	La société M.U.D. est une structure qui vous propose une sélection de formules à la carte.</p>
			</article>
			<article class="mud_article">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/seminaire.jpg" alt="Seminaires" class="img_article" />
			...
			<article class="mud_article">	
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/cabaret.jpg" alt="Cabarets." class="img_article" />
					<h3 class="mud_h3">GARANTIES</h3>
				<p>Nous sommes disposés à vous offrir le meilleur de nous à chaque instant.</p>
			</article>
			<article class="mud_article">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/representation.jpg" alt="Representatins." class="img_article" />
			...
			<article class="mud_article">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/video.jpg" alt="video" class="img_article" />
