...
{tooltip}<img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/img/informations.png" alt="Informations" /> {end-texte|w=350|mood=800|tipd=1000|offsety=50}<h2>Objectif:</h2>
		...
		<div id="bloc_page_site">
			...
			<article class="mud_article">
					<img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/img/mud/console_midas.jpg" alt="Consle Midas." class="img_article"/>
					<h3 class="mud_h3">LES MARQUES</h3>
				<p>
				BOSE - NEXO - SOUNDCRAFT - AMCRON - SHURE - ADB - MARTIN - JULIAT - SONY - MITSUBISHI</p>
			</article>
			<article class="mud_article">
					<img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/img/mud/spectacle.jpg" alt="Spectacle." class="img_article" />
