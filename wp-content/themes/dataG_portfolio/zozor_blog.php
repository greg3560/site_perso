	...
	<div id="zozor_bloc_page">
            <header id="zozor_header">
                <div id="titre_principal">
                    <img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/zozor_logo.png" alt="Logo de Zozor" id="zozor_logo" />
                    <h1>Zozor</h1>
            ...
            <section class="zozor_section">
                <article class="zozor_article">
                    <h1><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/ico_epingle.png" alt="Catégorie voyage" class="ico_categorie" />Je suis un grand voyageur</h1>
                ...
                <aside id="zozor_aside">
                    ...
                    <img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/bulle.png" alt="" id="fleche_bulle" />
                    <p id="photo_zozor"><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/zozor_classe.png" alt="Photo de Zozor" /></p>
                    ...
                    <p><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/facebook.png" alt="Facebook" /><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/twitter.png" alt="Twitter" /><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/vimeo.png" alt="Vimeo" /><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/flickr.png" alt="Flickr" /><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/rss.png" alt="RSS" /></p>
                </aside>
            </section>
            ...
            <footer id="zozor_footer">
                ...
                <div id="mes_photos">
                    <h1>Mes photos</h1>
                    <p><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/photo1.jpg" alt="Photographie" /><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/photo2.jpg" alt="Photographie" /><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/photo3.jpg" alt="Photographie" /><img src="<?php bloginfo('template_directory'); ?>/../dataG_portfolio/sites_web/blog_zozor/img/photo4.jpg" alt="Photographie" /></p>
                </div>
                <div id="mes_amis">
                    <h1>Mes amis</h1>
                    <ul>
