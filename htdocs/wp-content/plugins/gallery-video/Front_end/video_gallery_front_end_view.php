...
jQuery(document).ready(function(){
	...
	jQuery('.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> .videogallery-image-overlay a').on('click',function(){
		...
		jQuery(this).parents('body').append('<div id="huge-popup-overlay-video_<?php echo $videogalleryID; ?>"></div>');
		jQuery('#huge_it_videogallery_popup_list_<?php echo $videogalleryID; ?>').insertBefore('#huge-popup-overlay-video_<?php echo $videogalleryID; ?>');
...
//            alert(num+" "+cnt);
	...
	jQuery('body').on('click','#huge-popup-overlay-video_<?php echo $videogalleryID; ?>',function(){
		closePopup();
		return false;
	});
	...
	function closePopup() {
		...
		jQuery('#huge-popup-overlay-video_<?php echo $videogalleryID; ?>').remove();
...
#huge-popup-overlay-video_<?php echo $videogalleryID; ?> {
	position:fixed;
	top:0px;
	left:0px;
	width:100%;
