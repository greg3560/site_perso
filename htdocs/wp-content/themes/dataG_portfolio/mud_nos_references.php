...
{tooltip}<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/informations.png" alt="Informations" /> {end-texte|w=350|mood=800|tipd=1000|offsety=50}<h2>Objectif:</h2>
		...
		<div id="bloc_page_site">
			...
			<article class="mud_article">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/eclairage_architectural.jpg" alt="eclairage architectural." class="img_article"/>
			...
			<article class="mud_article">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/traduction_simultannee.jpg" alt="traduction simultannée" class="img_article" />
			...
			<article class="mud_article">	
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/les_societes.jpg" alt="Les sociétés." class="img_article" />
			...
			<article class="mud_article">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mud/les_villes.jpg" alt="Les villes" class="img_article" />
