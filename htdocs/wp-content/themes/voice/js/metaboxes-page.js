(function($) {
    $(document).ready(function (){
            ...
            $('body').on('click', '#vce-add-module-blank', function(e){
                e.preventDefault();
                tb_show( 'Add Module', '#TB_inline?width=600&height=600&inlineId=vce-hidden-module-blank' );
            });
        	...
        	$('body').on('click', 'a.vce-save-module', function(e){
                ...
                var mod_content = $(this).closest('.vce-module-form').find("textarea").first().val();
